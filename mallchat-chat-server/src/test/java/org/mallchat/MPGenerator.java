...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        //todo 要改输出路径
        globalConfig.setOutputDir("E:\\Git项目\\Mallchat\\Mallchat\\mallchat-chat-server\\src\\main\\java\\org\\mallchat\\user");
        //设置作者名字
        globalConfig.setAuthor("cjh");
        ...
        packageConfig.setParent("");//自定义包的路径
...
//        strategyConfig.setTableFillList(list);
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setPassword("root0128");
        dataSourceConfig.setUrl("jdbc:mysql://8.130.104.225:3306/mallchat?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}
